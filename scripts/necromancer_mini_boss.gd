...
var SKELETON = null
var FLOATING_SKULL = null

func _init():
	# Load scenes by path instead of UID (UIDs from Hansel's project don't match)
	if ResourceLoader.exists("res://scenes/Enemies/skeleton.tscn"):
		SKELETON = load("res://scenes/Enemies/skeleton.tscn")
	if ResourceLoader.exists("res://scenes/Enemies/floating_skull.tscn"):
		FLOATING_SKULL = load("res://scenes/Enemies/floating_skull.tscn")
